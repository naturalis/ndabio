...
function bioportal_theme_form_element($variables) {
  ...
  switch ($element['#title_display']) {
    case 'before':
      ...
      $output .= "\t<div class='small-2 small-offset-2 columns'> " . theme('form_element_label', $variables). "</div>\n";
      $output .= "\t<div class='small-5 columns end'> " .  $prefix . $element['#children'] . $suffix . "</div>\n";
      $output .= "</div>\n";
      break;
    case 'invisible':
