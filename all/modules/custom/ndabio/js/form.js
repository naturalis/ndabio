      ...
      if ( $("body").hasClass("page-geographic-search") ){
        ...
        alert(
    	  ...
    	  if (nrSimpleTermsElements > 1) {
    		  term = Drupal.t("One or more of the ") + nrSimpleTermsElements + Drupal.t(" elements in your search term is too short. ");
    	  }
    	  
		  var message = term + Drupal.t("Your search term should contain at least [nr] characters. This limitation does not apply to advanced search!");
